...
def build_graph(
    ...
    def retrieve(state: ConciergeState) -> dict:
    ...
    def grade_retrieval(state: ConciergeState) -> dict:
    ...
    def rewrite_query(state: ConciergeState) -> dict:
        docs = state.get("context_docs") or []
    ...
    def generate(state: ConciergeState) -> dict:
        docs = state.get("context_docs") or []
    ...
    def grade_answer(state: ConciergeState) -> dict:
    ...
    def after_retrieval(state: ConciergeState) -> str:
    ...
    def after_answer(state: ConciergeState) -> str:
